...
class TaskViewModel: ObservableObject {
    ...
    func scheduleNotification(for task: Task) {
        ...
        content.body = "Don't forget to complete this task! (\(task.category))"
            ...
            Form {
                ...
                Section(header: Text("Notifications")) {
                    Stepper(
                        ...
                        in: 5...1440, // Between 5 minutes and 24 hours
                        step: 5
                    ) {
                        HStack {
                            Text("Reminder Time")
                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            VStack(alignment: .leading) {
                                Toggle("Set Due Date", isOn: Binding(
                                    ...
                                    set: { if !$0 { editedTask.dueDate = nil } else if editedTask.dueDate == nil { editedTask.dueDate = Date() } }
                                ))
                                ...
                                if editedTask.dueDate != nil {
                                    ...
                                    Toggle("Set Due Time", isOn: Binding(
                                        get: { editedTask.dueTime != nil },
                                        set: { if !$0 { editedTask.dueTime = nil } else if editedTask.dueTime == nil { editedTask.dueTime = Date() } }
                                    ))
